...
def main():
    ...
    for i, gs in enumerate(gdf['Game slug']):
        ...
        for page in results["pages"]:
            ...
            try:
                ...
                pass
        if game_tags == []:
            gdf["tags"][i] = ['No tag data avalable']
        else:
            gdf["tags"][i] = game_tags
    ...
    action_games.to_csv('output/action_games_sorted.csv', columns =["Game slug", "Epic Games rating"], index=False)
